function [Kalman_result, inovace_KF] = Kalman_filter_ust(trajektorie_cell, mereni_cell, pocet_kroku, F, G, H, Q, R, x0_cov, x0_mean, K_inf)
%KALMAN_FILTER_STABLE Summary of this function goes here
%   Detailed explanation goes here
    Kalman_result = cell(1,1000);
    vektor_stavu_Kalman = zeros(pocet_kroku+1, 2); 
    inovace_KF = zeros(pocet_kroku+1, 1000); 

    K = K_inf; % zmena oproti klasickemu Kalmanovu filtru
